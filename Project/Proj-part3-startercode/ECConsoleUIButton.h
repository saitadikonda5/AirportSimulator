...
#include "../Proj-part1-startercode/ECFlightItinerary.h"
#include "../Proj-part1-startercode/ECAirlineSimulator.h"
...
ECConsoleUIButton(int xUL, int yUL, int xLR, int yLR, const std::string &textButton, ECConsoleUIListBox& sourceListBox, ECConsoleUIListBox& destinationListBox, ECConsoleUIListBox& itinerariesListBox, ECAirlineSimulator& simulator);
...
private:
    ...
    ECConsoleUIListBox& sourceListBox; // Reference to the source list box
    ECConsoleUIListBox& destinationListBox; // Reference to the destination list box
    ECConsoleUIListBox& itinerariesListBox; // Reference to the flight itineraries list box
